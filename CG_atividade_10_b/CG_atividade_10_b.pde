...
void setup() {
  size(640, 360, P3D);
  lado1 = loadImage("luz-azul.jpg");
  lado2 = loadImage("luz-azul.jpg");
  lado3 = loadImage("luz-azul.jpg");
  lado4 = loadImage("luz-azul.jpg");
  lado5 = loadImage("luz-azul.jpg");
  lado6 = loadImage("luz-azul.jpg");
  textureMode(NORMAL);
  fill(255);
